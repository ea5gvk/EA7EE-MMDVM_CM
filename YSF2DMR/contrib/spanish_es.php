...
$lang = array (
  ...
  // Config Page - YSF2DMR Configuration  
  "ysf2dmr_config"              =>  "Configuracion de EA7EE YSF2DMR", 
  "aprs_callsign"				=>	"Indicativo para acceso a servidor de APRS",
  "aprs_beacon_text"			=>	"Texto de la Baliza APRS del HotSpot",
  "aprs_beacon_icon"			=>	"Icono de la Baliza APRS",
  "aprs_beacon_time"			=>	"Periodo de la Baliza APRS(min)",
  "aprs_fi_apikey"				=>	"ApiKey de aprs.fi(Kms en panel Yaesu)",
  "voice_beacon_time"			=>	"Cadencia de Baliza de Voz (0=OFF)",
